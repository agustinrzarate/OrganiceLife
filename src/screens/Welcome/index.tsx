...
import { ButtonContainer, ImageBackground, LoginButton, SignInButton, Subtitle, TextButton, Title } from './styles';
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <ButtonContainer>
                ...
                <Shadow radius={30} distance={6} startColor="#6998ab29"
                    offset={[0, 24]} viewStyle={{ marginTop: 20 }}>
                    <SignInButton>
